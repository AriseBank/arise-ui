...
angular.module('ariseApp').controller('dappsCategoryController', ['$scope', 'viewFactory', '$http', '$stateParams', 'dappsService', '$timeout', 'gettextCatalog', function ($scope, viewFactory, $http, $stateParams, dappsService, $timeout, gettextCatalog) {
