...
angular.module('ariseApp').controller('errorModalController', ["$scope", "errorModal", "userService", 'gettextCatalog', function ($scope, errorModal, userService, gettextCatalog) {
